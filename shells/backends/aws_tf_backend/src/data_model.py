...
class AwsTfBackend:
    ...
    def bucket_name(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Bucket Name"]
            if "Aws Tf Backend.Bucket Name" in self.attributes
            else None
        )
    ...
    def region_name(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Region Name"]
            if "Aws Tf Backend.Region Name" in self.attributes
            else None
        )
    ...
    def access_key(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Access Key"]
            if "Aws Tf Backend.Access Key" in self.attributes
            else None
        )
    ...
    def secret_key(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Secret Key"]
            if "Aws Tf Backend.Secret Key" in self.attributes
            else None
        )
    ...
    def cloud_provider(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Cloud Provider"]
            if "Aws Tf Backend.Cloud Provider" in self.attributes
            else None
        )
    ...
    def hide_address(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.hide_address"]
            if "Aws Tf Backend.hide_address" in self.attributes
            else None
        )
    ...
    def user(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.User"]
            if "Aws Tf Backend.User" in self.attributes
            else None
        )
    ...
    def password(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Password"]
            if "Aws Tf Backend.Password" in self.attributes
            else None
        )
    ...
    def enable_password(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Enable Password"]
            if "Aws Tf Backend.Enable Password" in self.attributes
            else None
        )
    ...
    def power_management(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Power Management"]
            if "Aws Tf Backend.Power Management" in self.attributes
            else None
        )
    ...
    def sessions_concurrency_limit(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Sessions Concurrency Limit"]
            if "Aws Tf Backend.Sessions Concurrency Limit" in self.attributes
            else None
        )
    ...
    def snmp_read_community(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP Read Community"]
            if "Aws Tf Backend.SNMP Read Community" in self.attributes
            else None
        )
    ...
    def snmp_write_community(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP Write Community"]
            if "Aws Tf Backend.SNMP Write Community" in self.attributes
            else None
        )
    ...
    def snmp_v3_user(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP V3 User"]
            if "Aws Tf Backend.SNMP V3 User" in self.attributes
            else None
        )
    ...
    def snmp_v3_password(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP V3 Password"]
            if "Aws Tf Backend.SNMP V3 Password" in self.attributes
            else None
        )
    ...
    def snmp_v3_private_key(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP V3 Private Key"]
            if "Aws Tf Backend.SNMP V3 Private Key" in self.attributes
            else None
        )
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP V3 Authentication Protocol"]
            if "Aws Tf Backend.SNMP V3 Authentication Protocol" in self.attributes
            else None
        )
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP V3 Privacy Protocol"]
            if "Aws Tf Backend.SNMP V3 Privacy Protocol" in self.attributes
            else None
        )
    ...
    def snmp_version(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.SNMP Version"]
            if "Aws Tf Backend.SNMP Version" in self.attributes
            else None
        )
    ...
    def enable_snmp(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Enable SNMP"]
            if "Aws Tf Backend.Enable SNMP" in self.attributes
            else None
        )
    ...
    def disable_snmp(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Disable SNMP"]
            if "Aws Tf Backend.Disable SNMP" in self.attributes
            else None
        )
    ...
    def console_server_ip_address(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Console Server IP Address"]
            if "Aws Tf Backend.Console Server IP Address" in self.attributes
            else None
        )
    ...
    def console_user(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Console User"]
            if "Aws Tf Backend.Console User" in self.attributes
            else None
        )
    ...
    def console_port(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Console Port"]
            if "Aws Tf Backend.Console Port" in self.attributes
            else None
        )
    ...
    def console_password(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Console Password"]
            if "Aws Tf Backend.Console Password" in self.attributes
            else None
        )
    ...
    def cli_connection_type(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.CLI Connection Type"]
            if "Aws Tf Backend.CLI Connection Type" in self.attributes
            else None
        )
    ...
    def cli_tcp_port(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.CLI TCP Port"]
            if "Aws Tf Backend.CLI TCP Port" in self.attributes
            else None
        )
    ...
    def backup_location(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Backup Location"]
            if "Aws Tf Backend.Backup Location" in self.attributes
            else None
        )
    ...
    def backup_type(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Backup Type"]
            if "Aws Tf Backend.Backup Type" in self.attributes
            else None
        )
    ...
    def backup_user(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Backup User"]
            if "Aws Tf Backend.Backup User" in self.attributes
            else None
        )
    ...
    def backup_password(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.Backup Password"]
            if "Aws Tf Backend.Backup Password" in self.attributes
            else None
        )
...
class ResourcePort:
    ...
    def mac_address(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.ResourcePort.MAC Address"]
            if "Aws Tf Backend.ResourcePort.MAC Address" in self.attributes
            else None
        )
    ...
    def ipv4_address(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.ResourcePort.IPv4 Address"]
            if "Aws Tf Backend.ResourcePort.IPv4 Address" in self.attributes
            else None
        )
    ...
    def ipv6_address(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.ResourcePort.IPv6 Address"]
            if "Aws Tf Backend.ResourcePort.IPv6 Address" in self.attributes
            else None
        )
    ...
    def port_speed(self):
        ...
        return (
            ...
            if "Aws Tf Backend.ResourcePort.Port Speed" in self.attributes
            else None
        )
...
class GenericPowerPort:
    ...
    def model(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.GenericPowerPort.Model"]
            if "Aws Tf Backend.GenericPowerPort.Model" in self.attributes
            else None
        )
    ...
    def serial_number(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.GenericPowerPort.Serial Number"]
            if "Aws Tf Backend.GenericPowerPort.Serial Number" in self.attributes
            else None
        )
    ...
    def version(self):
        ...
        """
        return (
            self.attributes["Aws Tf Backend.GenericPowerPort.Version"]
            if "Aws Tf Backend.GenericPowerPort.Version" in self.attributes
            else None
        )
    ...
    def port_description(self):
        ...
        return (
            ...
            if "Aws Tf Backend.GenericPowerPort.Port Description" in self.attributes
            else None
        )
