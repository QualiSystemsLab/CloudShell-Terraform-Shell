...
class IntegrationData(object):
    def __init__(self, service_name: str, real_api: bool = True):
    ...
    def _set_context(self, real_api: bool = True):
        ...
        if real_api:
            ...
            self.set_context_resource_attributes_mocked()
    ...
    def set_context_resource_attributes_mocked(self, mocked_attributes: list[AttributeValueInfo] = None,
                                               the_only_attribute_to_update: str = ""):
        if mocked_attributes:
