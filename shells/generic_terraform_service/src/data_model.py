...
class GenericTerraformService:
    ...
    def github_terraform_module_url(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Github Terraform Module URL"]
            if "Generic Terraform Service.Github Terraform Module URL"
            in self.attributes
            else None
        )
    ...
    def terraform_version(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Terraform Version"]
            if "Generic Terraform Service.Terraform Version" in self.attributes
            else None
        )
    ...
    def github_token(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Github Token"]
            if "Generic Terraform Service.Github Token" in self.attributes
            else None
        )
    ...
    def cloud_provider(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Cloud Provider"]
            if "Generic Terraform Service.Cloud Provider" in self.attributes
            else None
        )
    ...
    def uuid(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.UUID"]
            if "Generic Terraform Service.UUID" in self.attributes
            else None
        )
    ...
    def branch(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Branch"]
            if "Generic Terraform Service.Branch" in self.attributes
            else None
        )
    ...
    def terraform_outputs(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Terraform Outputs"]
            if "Generic Terraform Service.Terraform Outputs" in self.attributes
            else None
        )
    ...
    def terraform_sensitive_outputs(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Terraform Sensitive Outputs"]
            if "Generic Terraform Service.Terraform Sensitive Outputs"
            in self.attributes
            else None
        )
    ...
    def terraform_inputs(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Terraform Inputs"]
            if "Generic Terraform Service.Terraform Inputs" in self.attributes
            else None
        )
    ...
    def remote_state_provider(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Remote State Provider"]
            if "Generic Terraform Service.Remote State Provider" in self.attributes
            else None
        )
    ...
    def custom_tags(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Custom Tags"]
            if "Generic Terraform Service.Custom Tags" in self.attributes
            else None
        )
    ...
    def apply_tags(self):
        ...
        """
        return (
            self.attributes["Generic Terraform Service.Apply Tags"]
            if "Generic Terraform Service.Apply Tags" in self.attributes
            else None
        )
