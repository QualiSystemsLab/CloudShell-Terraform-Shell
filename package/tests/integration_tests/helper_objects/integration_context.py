...
class RealAPIIntegrationData(BaseIntegrationData):
    def __init__(self, service_name: str):
        ...
        self._set_context()
        BaseIntegrationData.create_tf_shell(self)

    def _set_context(self):
        BaseIntegrationData._build_context(self)
        ...
        BaseIntegrationData._set_general_context_resource_data(self)
