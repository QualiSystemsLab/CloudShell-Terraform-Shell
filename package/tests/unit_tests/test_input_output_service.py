...
from cloudshell.iac.terraform.services.input_output_service import (
    InputOutputService,
    TFVar,
)
...
class TestInputOutputService(TestCase):
    ...
    def test_get_variables_from_var_attributes_model_name_contains_uppercase(self):
        ...
        input_output_service = InputOutputService(driver_helper, {}, {})
        input_output_service.try_decrypt_password = Mock(
            side_effect=TestHelper.return_original_val
        )
    ...
    def test_parse_and_save_outputs_with_mapped_attributes(self):
        ...
        driver_helper.tf_service.attributes = {var_name: "val1"}
        json_output = {"MyVar": {"sensitive": False, "type": "string", "value": "val1"}}
        input_output_service = InputOutputService(driver_helper, {}, {})
        ...
        self.assertEqual(
            driver_helper.api.SetServiceAttributesValues.call_args[0][2][0].Name,
            var_name,
        )
        self.assertEqual(
            driver_helper.api.SetServiceAttributesValues.call_args[0][2][0].Value,
            "val1",
        )
    ...
    def test_parse_and_save_outputs_with_mapped_attributes_and_outputs_attribute(self):
        ...
        tf_output_name = (
            f"{driver_helper.tf_service.cloudshell_model_name}.Terraform Outputs"
        )
        driver_helper.tf_service.attributes = {var_name: "val1", tf_output_name: ""}
        json_output = {
            "MyVar1": {"sensitive": False, "type": "string", "value": "val1"},
            "MyVar2": {"sensitive": False, "type": "string", "value": "val2"},
            "MyVar3": {"sensitive": False, "type": "string", "value": "val3"},
        }
        input_output_service = InputOutputService(driver_helper, {}, {})
        ...
        self.assertEqual(
            len(driver_helper.api.SetServiceAttributesValues.call_args[0][2]), 2
        )
    ...
    def test_parse_and_save_outputs_with_unmapped_attributes(self):
        ...
        json_output = {
            "MyVar1": {"sensitive": False, "type": "string", "value": "val1"},
            "MyVar2": {"sensitive": True, "type": "string", "value": "val2"},
            "MyVar3": {"sensitive": False, "type": "string", "value": "val3"},
        }
        input_output_service = InputOutputService(driver_helper, {}, {})
        ...
        attribute_update_req_list = (
            driver_helper.api.SetServiceAttributesValues.call_args[0][2]
        )
        sensitive_output_update_req = next(
            filter(
                lambda x: x.Name == tf_sensitive_output_name, attribute_update_req_list
            )
        )

        attribute_update_req = driver_helper.api.SetServiceAttributesValues.call_args[
            0
        ][2][0]
    ...
    def test_parse_and_save_outputs_with_explicitly_mapped_outputs(self):
        ...
        driver_helper = Mock()
        driver_helper.attr_handler.check_2nd_gen_attribute_exist.side_effect = (
            check_2nd_gen_attribute_exist
        )
        driver_helper.attr_handler.get_2nd_gen_attribute_full_name.side_effect = (
            TestHelper.return_original_val
        )
        driver_helper.tf_service.attributes = {"attribute1": "", "attribute2": ""}
        json_output = {"MyVar": {"sensitive": False, "type": "string", "value": "val1"}}
        outputs_map = {"MyVar": "attribute1"}
    ...
    def test_get_variables_from_explicitly_mapped_attributes(self):
        ...
        driver_helper = Mock()
        driver_helper.attr_handler.check_attribute_exist.side_effect = (
            attribute_exists_mock
        )
        driver_helper.attr_handler.get_attribute.side_effect = get_attribute_mock
        inputs_map = {"attribute2": "tfvar1", "attribute4": "tfvar2"}
