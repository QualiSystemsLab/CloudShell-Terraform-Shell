...
class ObjectFactory:
    ...
    def create_tf_proc_executer(config: TerraformShellConfig,
                                sandbox_data_handler, shell_helper, tf_working_dir):
    ...
    @staticmethod
    def create_shell_helper(tf_service: TerraformServiceObject, context: ResourceCommandContext,
                             config: TerraformShellConfig, logger: logging.Logger) -> ShellHelperObject:
