...
class ProviderHandler(object):
    ...
    @staticmethod
    def initialize_provider(driver_helper: ShellHelperObject):
        ...
        try:
            if clp_res_model == 'Microsoft Azure' or clp_res_model == AZURE2G_MODEL:
                driver_helper.api.WriteMessageToReservationOutput(driver_helper.sandbox_id, "Initializing provider...")
